...
const HomePage: React.FC = () => {
  ...
  return(
    <div style={{display: 'flex', flexDirection: 'column', width: '100%', boxSizing: 'border-box', gap: '12px', paddingTop: '12px'}}>
      ...
      <div style={{ marginBottom: '200px', display: 'flex', flexDirection: 'row', gap: '8px', width: '200px', flexWrap: 'wrap' }}>
