      ...
      <div className={`main-about-wrapper ${isDesktop && 'desktop'}`}>
        <div className={`text-block-wrapper ${isDesktop && 'desktop'}`}>
          ...
          <div className="text-wrapper">
            <div className={`main-text ${isDesktop && 'desktop'} ${isTablet && 'tablet'} animation-02s-all ${currTheme === ColorTheme.DARK ? 'white' : 'dark'}`}>
              {currLang === Lang.ENG
            ...
            <div className={`mt13 ${isDesktop && 'desktop'} ${isTablet && 'tablet'} main-text animation-02s-all ${currTheme === ColorTheme.DARK ? 'white' : 'dark'}`}>
              {currLang === Lang.ENG
