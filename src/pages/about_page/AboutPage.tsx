        ...
        <div className={`text-block-wrapper ${isDesktop && 'desktop'}`}>
          ...
          <div className="text-wrapper">
            <TextFormatterComponent
              ...
              additionalStyles={`main-text ${isDesktop && 'desktop'} ${isTablet && 'tablet'} animation-02s-all ${currTheme === ColorTheme.DARK ? 'white' : 'dark'}`}
            ...
            <TextFormatterComponent
              ...
              additionalStyles={`mt13 ${isDesktop && 'desktop'} ${isTablet && 'tablet'} main-text animation-02s-all ${currTheme === ColorTheme.DARK ? 'white' : 'dark'}`}
              letterWidth={(isDesktop || isTablet) ? 11 : 9.9}
            />
          </div>
        </div>
